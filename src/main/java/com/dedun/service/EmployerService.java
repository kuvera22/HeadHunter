...
public class EmployerService {
    ...
    public EmployerResponse saveEmployer(EmployerRequest employerRequest) throws HeadHunterException {
        ...
        Employer employer = new Employer(employerRequest.getLogin(), null, employerRequest.getEmployerName(), employerRequest.getFirstName(), employerRequest.getLastName(), employerRequest.getEmail());
        employer.setPassword(employerRequest.getPassword());
        employerRepository.save(employer);
        return new EmployerResponse(employer.getId(), employer.getLogin(), employer.getEmployerName(), employer.getFirstName(), employer.getLastName(), employer.getEmail());
    }

    public List<EmployerResponse> getAll() {
        return employerRepository.findAll().stream().map(employer -> new EmployerResponse(employer.getId(), employer.getLogin(), employer.getEmployerName(), employer.getFirstName(), employer.getLastName(), employer.getEmail())).collect(Collectors.toList());
    }
